...
public class DatabaseHelper extends SQLiteOpenHelper
{
    ...
    public void CreatePatient(String[] values)
    {
        ...
        value.put(Patient.Column_ngt ,values[12]);


        value.put(Patient.Column_hasIvf ,values[8]);
        value.put(Patient.Column_hasMedication,values[9]);
        value.put(Patient.Column_hasNeb ,values[10]);
        value.put(Patient.Column_hasVsq,values[11]);
    ...
    {
        ContentValues value= new ContentValues();
        value.put(PatientTime.Column_bloodPressure ,values[0]);
        value.put(PatientTime.Column_ivf ,values[1]);
        value.put(PatientTime.Column_oxygen,values[2]);
        value.put(PatientTime.Column_patientId,values[3]);
        value.put(PatientTime.Column_pulseRate ,values[4]);
        value.put(PatientTime.Column_temperature,values[5]);
        value.put(PatientTime.Column_timePeriod,values[6]);
        long timeTbl_id=db.insert(PatientTime.TABLE_NAME,null,value);
    }
    private void CreatePatientIntake(String[] values)
    {
        ContentValues value= new ContentValues();
        value.put(PatientIntake.Column_milkIn ,values[0]);
        value.put(PatientIntake.Column_patientId,values[1]);
        value.put(PatientIntake.Column_stoolInput,values[2]);
        value.put(PatientIntake.Column_timePeriod,values[3]);
        value.put(PatientIntake.Column_urineInput ,values[4]);
        value.put(PatientIntake.Column_urineOutput,values[5]);
        value.put(PatientIntake.Column_waterIn,values[6]);
